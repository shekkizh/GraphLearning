...
def knn_graph(G, mask, knn_param, reg=1e-6, directed=False):
    """
    ...
    :param directed: Boolean flag to leave graph directed without symmetrization
...
def nnk_graph(G, mask, knn_param, reg=1e-6, directed=False):
    """
